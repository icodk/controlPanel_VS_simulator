...
static const menuItem_t mainMenu[] = {
    {MENU_ITEM_TYPE_MENU_HEADER,	T_MAIN_MENU,         NULL,   EE_NDX_NONE,ACCESS_LEVEL_0,NO_MIN,NO_MAX},
        {MENU_ITEM_TYPE_SYS_NUM_DEC1,	T_PARAM, 	NULL,		EE_NDX_NONE,ACCESS_LEVEL_0,	NULL,NULL},
        {MENU_ITEM_TYPE_SYS_NUM_DEC1, T_PARAM,      NULL, EE_NDX_NONE, ACCESS_LEVEL_0,NULL, NULL},
        {MENU_ITEM_TYPE_SUB_MENU, T_SYSTEM,       systemMenu, EE_NDX_NONE, ACCESS_LEVEL_0,NULL, NULL},
         { MENU_ITEM_TYPE_INFO_VERSION, T_INFO,       NULL, EE_NDX_NONE, ACCESS_LEVEL_0,NULL, NULL},
        /*
        {MENU_ITEM_TYPE_SYS_NUM_DEC1, T_STRING_PARAM, NULL, EE_NDX_NONE, ACCESS_LEVEL_0,NULL, NULL},
        {MENU_ITEM_TYPE_SYS_NUM_DEC1, T_DECIMAL_NUM, 				    NULL,		EE_NDX_NONE,ACCESS_LEVEL_0,	NULL,NULL},
        {MENU_ITEM_TYPE_SYS_NUM_DEC1, T_INT_PARAM, NULL, EE_NDX_NONE, ACCESS_LEVEL_0,NULL, NULL},
        {MENU_ITEM_TYPE_SYS_NUM_DEC1, T_SUB_MENU, NULL, EE_NDX_NONE, ACCESS_LEVEL_0,NULL, NULL},
        {MENU_ITEM_TYPE_SYS_NUM_DEC1, T_PARAM, NULL, EE_NDX_NONE, ACCESS_LEVEL_0,NULL, NULL},
        {MENU_ITEM_TYPE_SYS_NUM_DEC1,   T_PARAM, NULL,		EE_NDX_NONE,ACCESS_LEVEL_0,	NULL,NULL},
        {MENU_ITEM_TYPE_SYS_NUM_DEC1, T_PARAM, NULL, EE_NDX_NONE, ACCESS_LEVEL_0,NULL, NULL},
        {MENU_ITEM_TYPE_SYS_NUM_DEC1, T_PARAM, NULL, EE_NDX_NONE, ACCESS_LEVEL_0,NULL, NULL},
...
{MENU_ITEM_TYPE_MENU_HEADER, T_SYSTEM, mainMenu, EE_NDX_NONE, ACCESS_LEVEL_0, NO_MIN, NO_MAX},
    {MENU_ITEM_TYPE_SUB_MENU, T_NETWORK,       networkMenu, EE_NDX_NONE, ACCESS_LEVEL_0,NULL, NULL},
    { MENU_ITEM_TYPE_SYS_NUM_DEC1, T_STRING_PARAM, NULL, EE_NDX_NONE, ACCESS_LEVEL_0,NULL, NULL },
    { MENU_ITEM_TYPE_SYS_NUM_DEC1, T_DECIMAL_NUM, 				    NULL,		EE_NDX_NONE,ACCESS_LEVEL_0,	NULL,NULL },
    { MENU_ITEM_TYPE_SYS_NUM_DEC1, T_INT_PARAM, NULL, EE_NDX_NONE, ACCESS_LEVEL_0,NULL, NULL },
    { MENU_ITEM_TYPE_SYS_NUM_DEC1, T_DECIMAL_NUM, 				    NULL,		EE_NDX_NONE,ACCESS_LEVEL_0,	NULL,NULL },
